...
public class User implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        // return Collections.emptyList();//Kono Role ny user er,user admin oww na,user
        // oww na

        // portek to roleslist a ke map er maddhome alada alada korci ,tarpor
        // SimpleGrantedAuthority er maddhome convert kore collect korci
